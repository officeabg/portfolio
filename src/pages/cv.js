          ...
          <Layout>
            ...
            <div id="print-wrapper">
              <Print single name="foo">
                      ...
                      <div className="row text-white">
                        ...
                        <div className="col-md-5">
                          ...
                          <p className="cv-p text-b">
                            Experienced Frontend Developer with more than 10
                            years of experience. Frontend Development with
                            technologies: HTML, CSS, JavaScript, React. BackEnd
                            experience with Meteor, MongoDB, GraphQL.
                            Experienced graphic designer Adobe Photoshop print &
                            web. Designed, developed & managed over 30 websites.
                          </p>
                          <hr />
                          <div className="row text-white">
                            <div className="col-md-3">
                ...
                <section id="skills" className="white-b">
                  <div className="container-fluid">
                    <div className="row">
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-8">
                        ...
                        <div className="row contact text-white">
                          ...
                          <hr />
                          <p className="cv-p text-b">
                            Managing freelance jobs and everything from sales
                            pitches, presentations, finding appropriate
                            solutions for different tasks too hard coding. I
                            cover most of the IT solutions and I can provide
                            fast, services that are included in our offer. As a
                            designer, I have a perfect connection with
                            open-source development platforms like Joomla,
                            Wordpress, Magento, and others, as well as plain
                            HTML, CSS & Javascript based websites. Ability to
                            work with frameworks like Blaze, React, Bootstrap,
                            Uikit, and others.
                          </p>
                          <hr />
                        </div>
                        <div className="row contact text-white">
                          ...
                          <p className="cv-p text-b">
                            ...
                            different areas of IT solutions provided. Impact
                            sales through coaching, counseling, and influencing
                            others to accomplish desired outcomes Responsible
                            for developing revenue streams in line with company
                            strategy, focusing on site-specific sales and margin
                            growth, and critical cost control Assisting the
                            Management team in pricing and preparing tender
                            submissions and written proposals to clients
                            Communicating with clients and development team to
                            reach customers goal on a daily basis. Carrying out
              ...
              <div className="row text-white down">
